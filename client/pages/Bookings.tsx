...
import { ArrowLeft, Calendar, User, Zap, Shield } from "lucide-react";
        ...
        <Card>
          ...
          <CardContent className="text-center">
            <p className="text-muted-foreground mb-6">
              This section will display your upcoming bookings, booking history,
              total spending tracker, and options to reschedule or cancel
              appointments.
            </p>
